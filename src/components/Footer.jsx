      ...
      <footer className="bg-gradient-to-r from-teal-500 to-teal-700 py-12 ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between">
          <div className="flex items-center mb-5 md:mb-0">
            <img
              className="w-[90px] h-[50px] md:w-[130px] md:h-[80px] -mt-7"
              src="./images/image (4).png"
              alt="Footer Logo 1"
            />
            <img
              className="w-[130px] h-[80px] md:w-[200px] md:h-[140px]"
              src="./images/image (5).png"
              alt="Footer Logo 2"
            />
            <img
              className="w-[90px] h-[70px] ml-auto mr-auto md:ml-0 md:mr-0 md:w-[130px] md:h-[140px] -mt-4 md:-mt-6"
