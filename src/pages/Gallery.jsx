  ...
  return (
    <>
      ...
      <div className="max-w-7xl mt-10 mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {[...Array(78)].map((_, i) => (
  <div key={i} className="relative overflow-hidden rounded-lg shadow-lg cursor-pointer">
    <img
      src={`./images/Web Site Photo/Woglo Tours and Travels, Aluva, Ernakulam, Kerala, India (${i+1}).jpeg`}
